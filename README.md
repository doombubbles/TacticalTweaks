...
This is an offshoot of my [Useful Utilities mod](https://github.com/doombubbles/useful-utilities) that includes tweaks that are more gameplay altering.
Incorporates a few things ported from Useful Utilities, a few of my old mods, and many new tweaks.
...
- Better Monkey City (Default Off)
...
- Better Central Market (Default Off)
